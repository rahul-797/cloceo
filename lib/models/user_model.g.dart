...
_$_UserModel _$$_UserModelFromJson(Map<String, dynamic> json) => _$_UserModel(
      ...
      habitBreakDetails: (json['habitBreakDetails'] as List<dynamic>).map((e) => e as Map<String, dynamic>).toList(),
      habitBreakRecords: (json['habitBreakRecords'] as List<dynamic>).map((e) => e as Map<String, dynamic>).toList(),
    );
...
Map<String, dynamic> _$$_UserModelToJson(_$_UserModel instance) => <String, dynamic>{
      ...
      'habitBreakDetails': instance.habitBreakDetails,
      'habitBreakRecords': instance.habitBreakRecords,
    };
